...
soundObj = pm.Sound(
    "Uni/ma_thesis/quelldaten/DIRNDL-prosody/dlf-nachrichten-200703271500.wav")
...
for validPeakIndex in range(validPeakCount):
    ...
    queryInterval = call(textGridObj, "Get interval at time", 1, queryTiming)
    queryLabel = call(textGridObj, "Get label of interval", 1, queryInterval)
...
textGridObj.save_as_text_file("dlf-nachrichten-200703271500.TextGrid")
